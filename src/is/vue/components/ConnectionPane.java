...
public class ConnectionPane extends JPanel {
	...
	private JTextField login, server, pass, port;
	...
	public ConnectionPane() {
		...
		server = new JTextField("127.0.0.1", 20);
		server_label.setLabelFor(server);

		login = new JTextField("pc2r", 20);
		login_label.setLabelFor(login);
		
		port = new JTextField("2013", 20);
		port_label.setLabelFor(port);
